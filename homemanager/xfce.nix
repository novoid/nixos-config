...
#        "/lock/enabled" = enableSaver config.networking.hostName;
      ...
      xfce4-keyboard-shortcuts = { # 2023-07-29: MUST have leading slashes
        ...
        "/commands/custom/<Primary>F1" = "/home/vk/src/misc/vksave-window-positions.sh"; # DEPENDENCY
        "/commands/custom/<Primary>F2" = "/home/vk/src/misc/vkrestore-window-positions.sh"; # DEPENDENCY
...
#         "providers" = <<UNSUPPORTED>>;
        ...
        "/xfwm4/default/<Primary><Shift>F9"  = "move_window_workspace_1_key";
        "/xfwm4/default/<Primary><Shift>F10" = "move_window_workspace_2_key";
        "/xfwm4/default/<Primary><Shift>F11" = "move_window_workspace_3_key";
        "/xfwm4/default/<Primary><Shift>F12" = "move_window_workspace_4_key";
